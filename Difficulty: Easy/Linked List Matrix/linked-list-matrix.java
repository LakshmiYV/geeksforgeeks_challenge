...
class Solution {
    static Node construct(int mat[][]) {
        ...
        // Step 1: Create Node objects for each element in the matrix
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
        ...
        // Step 2: Link the nodes' right and down pointers
        for (int i = 0; i < n; i++) {
            for (int j = 0; j < n; j++) {
                if (j + 1 < n) {
        ...
        // Step 3: Return the head of the linked list (top-left node)
