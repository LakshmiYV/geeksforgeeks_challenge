...
class Solution {
    ...
    public ArrayList<Integer> bottomView(Node root) {
        // Create a map to store the horizontal distance and corresponding node's value
        ...
        while (!queue.isEmpty()) {
            ...
            // Add left and right children to the queue with corresponding horizontal distances
            if (node.left != null) {
        ...
        // Extract the values from the map to get the bottom view
