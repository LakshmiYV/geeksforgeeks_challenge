...
class Solution {
    ...
    Node copyList(Node head) {
        ...
        while (curr != null) {
            ...
            curr = curr.next.next; // Move two steps to skip to the next original node.
        }

        // Step 3: Separate the original and copied nodes into two lists.
        Node original = head, copy = head.next;
        Node copyHead = copy; // Save the head of the copied list.
